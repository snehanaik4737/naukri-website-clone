    ...
    <>
      ...
      <Box w={"100%"} background={"rgb(238,238,238)"} display={"flex"}>
        <Box w={"60%"} marginLeft={"4%"}>
          <Box
          className={styles.right_first_div}
          ...
          >
            ...
            ></img>
            <h4
            className={styles.first_div_heading}
          ...
          <h4
           ...
           className={styles.second_div_upper_heading}
          ...
          >
            <Box paddingTop={"2%"} w={"60%"} marginLeft={"5%"}>
              <h4
              className={styles.second_div_first_heading}
              ...
              <Box display={"flex"}>
                <BsFillFileTextFill 
                className={styles.experince_icon}
          ...
          <Box
           className={styles.third_div}
          >
            <h2
            className={styles.third_div_heading}
          ...
          >
            ...
            <Box w={"100%"} display={"flex"} padding={"4%"}>
              <Box w={"15%"}></Box>
            ...
            <Box w={"100%"} display={"flex"} padding={"4%"}>
              ...
              <Box w={"26%"} textAlign={"center"}>
                <Link to="">
                  <p style={{ color: "blue", fontSize: "17px" }}>
                    SEND MESSAGE
                  </p>
                </Link>
              </Box>
        ...
        <Box w={"25%"} marginLeft={"6%"}>
          ...
          >
            ...
            <p style={{ color: "blue", marginLeft: "60%",marginTop:"4%" }}>KNOW MORE</p>
            <p style={{ fontSize: "1rem", fontWeight: "bold",marginTop:"4%" }}>
            ...
            <p style={{ color: "blue", marginLeft: "60%",marginTop:"4%" }}>KNOW MORE</p>
            <p style={{marginTop:"4%"}}>Call 1800-572-5557 now! (Toll-free)</p>
          </Box>
          ...
          >
            ...
            <p style={{marginTop:"4%"}}>Click here for frequently asked questions.</p>
